"""
Django settings for skindisease_project project.

Generated for Skin Disease Detection Web Application.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-change-this-for-production-use-a-secure-key')
...
ROOT_URLCONF = 'skindisease_project.urls'
...
WSGI_APPLICATION = 'skindisease_project.wsgi.application'
